...
I have been using dbt cloud at work wherein each team's data analyst takes ownership of the team's semantic layer. But I wanted to build my own dbt core project and get comfortable with setting it up myself. 
...
I've gotten back to the basics and review what is the role of my dbt_project.yml, my profiles.yml. Follow the medallion architecture to ensure data quality. How to create my sources, build incremental models, how to run snapshots from ephemeral models to build my dim and fact tables. And Create my own macros and use jinja as needed to avoid long and redundant code. And as a last step, create tests to check the quality of my data.
